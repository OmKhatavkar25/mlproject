...
class DataIngestionConfig:
    train_data_path: str = os.path.join('artifactc', "train.csv")
    test_data_path: str = os.path.join('artifactc', "test.csv")
    raw_data_path: str = os.path.join('artifactc', "data.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            df = pd.read_csv(r"D:\mlproject\src\components\notebook\data\stud.csv")
